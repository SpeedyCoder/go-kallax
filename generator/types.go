...
var specialTypes = map[string]string{
	"github.com/SpeedyCoder/go-kallax.UUID":      "kallax.UUID",
	"github.com/SpeedyCoder/go-kallax.ULID":      "kallax.ULID",
	"github.com/SpeedyCoder/go-kallax.NumericID": "kallax.NumericID",
