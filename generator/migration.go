...
var typeMappings = map[string]ColumnType{
	"github.com/SpeedyCoder/go-kallax.ULID":      UUIDColumn,
	"github.com/SpeedyCoder/go-kallax.UUID":      UUIDColumn,
	"github.com/SpeedyCoder/go-kallax.NumericID": BigIntColumn,
