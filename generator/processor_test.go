...
func (s *ProcessorSuite) TestInlineStruct() {
  ...
  import  "github.com/SpeedyCoder/go-kallax"
...
func TestRemoveGoPath(t *testing.T) {
	...
	cases := []struct {
		...
		{
			`E:\workspace\gopath\src\github.com\SpeedyCoder\go-kallax\tests\fixtures.AliasString`,
			"github.com/SpeedyCoder/go-kallax/tests/fixtures.AliasString",
			[]string{
				`E:\workspace\gopath`,
			},
			'\\',
		...
		{
			"/home/workspace/gopath/src/github.com/SpeedyCoder/go-kallax/tests/fixtures.AliasString",
			"github.com/SpeedyCoder/go-kallax/tests/fixtures.AliasString",
			[]string{
				"/home/foo/go",
		...
		{
			"/home/workspace/gopath/src/foo/bar/vendor/github.com/SpeedyCoder/go-kallax/tests/fixtures.AliasString",
			"github.com/SpeedyCoder/go-kallax/tests/fixtures.AliasString",
			[]string{
				"/home/foo/go",
				"/home/workspace/gopath",
		...
		{
			"/home/vendor/workspace/gopath/src/github.com/SpeedyCoder/go-kallax/tests/fixtures.AliasString",
			"github.com/SpeedyCoder/go-kallax/tests/fixtures.AliasString",
			[]string{
				"/home/foo/go",
		...
		{
			"/home/vendor/workspace/gopath/src/vendor/github.com/SpeedyCoder/go-kallax/tests/fixtures.AliasString",
			"github.com/SpeedyCoder/go-kallax/tests/fixtures.AliasString",
			[]string{
				"/home/foo/go",
				"/home/vendor/workspace/gopath",
